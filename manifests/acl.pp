...
# @param group Specify the group for which this ACL rule applies. Start the group name with the '@' sign and use '*' to apply rule to all groups.
# @param permission Specify the permission for this ACL rule. Possible permissions are: 1 for read, 2 edit, 4 create, 8 upload. See https://www.dokuwiki.org/acl for more information.
define dokuwiki::acl (
  String $user,
  String $group,
  Numeric $permission,
